 ...
 */
class WC_Plugin_Tests_Bootstrap {

	/** @var WC_Plugin_Tests_Bootstrap instance */
	...
	public function __construct() {
		...
		// load WC
		tests_add_filter( 'muplugins_loaded', array( $this, 'load_wc_test_plugin' ) );

		// install WC
		tests_add_filter( 'init', array( $this, 'install_wc_test_plugin' ) );
	 ...
	 * @since 2.2
	 */
	public function load_wc_test_plugin() {
	 ...
	 * @since 2.2
	 */
	public function install_wc_test_plugin() {
	 ...
	 *
	 * @since 2.2
	 * @return WC_Plugin_Tests_Bootstrap
	 */
...
WC_Plugin_Tests_Bootstrap::instance();